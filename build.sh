...
ffmpeg -i ${VIDIN} -c:v libx265 -c:a aac output_h265.mp4
ffmpeg -i ${VIDIN} -c:v wmv1 -c:a wmav2 output_wmv1.asf
ffmpeg -i ${VIDIN} -c:v libx265 -c:a libopus output_h265.mkv
ffmpeg -i ${VIDIN} -c:v flv -c:a mp3 output_h263.flv
